...
public class ReadPostingProfilesCallTest {
    @Autowired
    ...
    public void readPaymentMethodsShouldWork() throws BillingServiceException {
        List<ConverterValue<Integer>> paymentMethods = converterValuesHandler.getPostingProfiles();
        assertThat(paymentMethods, notNullValue());
        assertThat(paymentMethods.size(), is(3));
        assertThat(paymentMethods.get(0).axValue, is("SO_1"));
    }
