 ...
 * @since 2012-07-02
 */
public class InvoicingRuleCreatedToWsTransformerTest {
    ...
    public void testTransform() throws Exception {
        ...
        InvoicingRuleToAxSalesInvoiceRuleTransformer transformer = new InvoicingRuleToAxSalesInvoiceRuleTransformer(converter, invoicingRuleCreated.getInvoicingRule(), "18811826");
        AxdEntityMDSSalesInvoiceRule salesInvoiceRule = transformer.transform();

        collector.checkThat(salesInvoiceRule.getBelongsToDataAreaId().getValue(), is("18811826"));
        collector.checkThat(salesInvoiceRule.getAction(), nullValue());
        ...
        collector.checkThat(salesInvoiceRule.getDocumentHash(), nullValue());
        ...
        collector.checkThat(message.getAction(), nullValue());
