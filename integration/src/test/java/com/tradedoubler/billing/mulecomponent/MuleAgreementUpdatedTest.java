...
public class MuleAgreementUpdatedTest {
    @Autowired
    ...
    private MuleAgreementUpdated componentToTest;
    ...
    public void normalFlowShouldWork() throws Exception {
        ...
        when(axService.updateAgreement(serviceResult)).thenReturn(serviceResult);
        ...
        verify(axService).updateAgreement(serviceResult);
    }
    ...
    public void runtimeExeceptionShouldBeStoredInServiceResult() throws Exception {
        ...
        when(axService.updateAgreement(serviceResult)).thenThrow(
    ...
    public void outOfSequenceShouldPassThough() throws Exception {
        ...
        componentToTest = new MuleAgreementUpdated();
    ...
    public void setupMock() throws Exception {
        ...
        componentToTest = applicationContextUtil.registerAnnotatedBean(MuleAgreementUpdated.class);
    }
