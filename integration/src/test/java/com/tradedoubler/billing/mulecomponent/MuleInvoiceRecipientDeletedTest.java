...
public class MuleInvoiceRecipientDeletedTest {
    @Autowired
    ...
    private MuleInvoiceRecipientDeleted componentToTest;
    ...
    public void normalFlowShouldWork() throws Exception {
        ...
        when(axService.deleteInvoiceRecipient(serviceResult)).thenReturn(serviceResult);
        ...
        verify(axService).deleteInvoiceRecipient(serviceResult);
    }
    ...
    public void runtimeExeceptionShouldBeStoredInServiceResult() throws Exception {
        ...
        when(axService.deleteInvoiceRecipient(serviceResult)).thenThrow(
    ...
    public void outOfSequenceShouldPassThough() throws Exception {
        ...
        componentToTest = new MuleInvoiceRecipientDeleted();
    ...
    public void setupMock() throws Exception {
        ...
        componentToTest = applicationContextUtil.registerAnnotatedBean(MuleInvoiceRecipientDeleted.class);
    }
