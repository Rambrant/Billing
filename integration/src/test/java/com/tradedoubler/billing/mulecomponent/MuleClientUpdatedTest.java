...
public class MuleClientUpdatedTest {
    @Autowired
    ...
    private MuleClientUpdated componentToTest;
    ...
    public void normalFlowShouldWork() throws Exception {
        ...
        when(axService.updateClient(serviceResult)).thenReturn(serviceResult);
        ...
        verify(axService).updateClient(serviceResult);
    }
    ...
    public void runtimeExeceptionShouldBeStoredInServiceResult() throws Exception {
        ...
        when(axService.updateClient(serviceResult)).thenThrow(
    ...
    public void outOfSequenceShouldPassThough() throws Exception {
        ...
        componentToTest = new MuleClientUpdated();
    ...
    public void setupMock() throws Exception {
        ...
        componentToTest = applicationContextUtil.registerAnnotatedBean(MuleClientUpdated.class);
    }
