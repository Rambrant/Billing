...
public class AgreementUpdatedValidationTest {
    @Autowired
    ...
    public void setUp() throws Exception {
        ...
        validationProcessor.setJsonSchemaPath("validation/schema/billing/agreement-updated-schema.json");
    }

    @Test
    public void agreementUpdatedExampleShouldWork() throws Exception {
    ...
    @Test
    public void illegalAgreementUpdatedExampleShouldNotWork() throws Exception {
    ...
    private void assertServiceResultFail(boolean isFail) {
        ...
        assertEquals(value.getErrorMessage(), isFail, value.isBugDisturbance());
    }
