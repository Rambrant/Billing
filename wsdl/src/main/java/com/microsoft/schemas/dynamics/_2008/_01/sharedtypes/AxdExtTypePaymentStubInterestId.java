...
/**
 * <p>Java class for AxdExtType_PaymentStubInterestId.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AxdExtType_PaymentStubInterestId">
...
public enum AxdExtTypePaymentStubInterestId {
    ...
    AxdExtTypePaymentStubInterestId(String v) {
        value = v;
    }
    ...
    public static AxdExtTypePaymentStubInterestId fromValue(String v) {
        for (AxdExtTypePaymentStubInterestId c: AxdExtTypePaymentStubInterestId.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
