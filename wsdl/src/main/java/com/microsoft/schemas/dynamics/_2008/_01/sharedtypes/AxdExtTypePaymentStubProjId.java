...
/**
 * <p>Java class for AxdExtType_PaymentStubProjId.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AxdExtType_PaymentStubProjId">
 ...
 * 
 */
@XmlType(name = "AxdExtType_PaymentStubProjId")
@XmlEnum
public enum AxdExtTypePaymentStubProjId {
    ...
    AxdExtTypePaymentStubProjId(String v) {
        value = v;
    }
    ...
    public static AxdExtTypePaymentStubProjId fromValue(String v) {
        for (AxdExtTypePaymentStubProjId c: AxdExtTypePaymentStubProjId.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
