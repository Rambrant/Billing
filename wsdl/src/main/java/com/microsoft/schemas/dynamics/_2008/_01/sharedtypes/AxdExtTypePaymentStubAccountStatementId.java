...
/**
 * <p>Java class for AxdExtType_PaymentStubAccountStatementId.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AxdExtType_PaymentStubAccountStatementId">
 ...
 * 
 */
@XmlType(name = "AxdExtType_PaymentStubAccountStatementId")
@XmlEnum
public enum AxdExtTypePaymentStubAccountStatementId {
    ...
    AxdExtTypePaymentStubAccountStatementId(String v) {
        value = v;
    }
    ...
    public static AxdExtTypePaymentStubAccountStatementId fromValue(String v) {
        for (AxdExtTypePaymentStubAccountStatementId c: AxdExtTypePaymentStubAccountStatementId.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
