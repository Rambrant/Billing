...
/**
 * <p>Java class for AxdExtType_PaymentStubInvoiceId.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="AxdExtType_PaymentStubInvoiceId">
 ...
 * 
 */
@XmlType(name = "AxdExtType_PaymentStubInvoiceId")
@XmlEnum
public enum AxdExtTypePaymentStubInvoiceId {
    ...
    AxdExtTypePaymentStubInvoiceId(String v) {
        value = v;
    }
    ...
    public static AxdExtTypePaymentStubInvoiceId fromValue(String v) {
        for (AxdExtTypePaymentStubInvoiceId c: AxdExtTypePaymentStubInvoiceId.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
