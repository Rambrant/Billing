...
public class AxdEntityMDSSalesInvoiceMessage {
    ...
    @XmlElementRef(name = "_DocumentHash", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvMes", type = JAXBElement.class)
    protected JAXBElement<String> documentHash;
    @XmlElement(name = "InvoiceMessageId", required = true)
    protected String invoiceMessageId;
    @XmlElementRef(name = "RecId", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvMes", type = JAXBElement.class)
    protected JAXBElement<Long> recId;
    @XmlElementRef(name = "RecVersion", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvMes", type = JAXBElement.class)
    protected JAXBElement<Integer> recVersion;
    @XmlElementRef(name = "RefRecId", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvMes", type = JAXBElement.class)
    protected JAXBElement<Long> refRecId;
    @XmlElementRef(name = "RefTableId", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvMes", type = JAXBElement.class)
