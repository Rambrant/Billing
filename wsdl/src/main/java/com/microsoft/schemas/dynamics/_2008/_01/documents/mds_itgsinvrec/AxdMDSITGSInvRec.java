...
/**
 * <p>Java class for AxdMDS_ITGSInvRec complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AxdMDS_ITGSInvRec">
 *   &lt;complexContent>
 ...
 *         &lt;element name="MDS_SalesInvoiceRecipient" type="{http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec}AxdEntity_MDS_SalesInvoiceRecipient" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AxdMDS_ITGSInvRec", propOrder = {
    "docPurpose",
    "senderId",
    "validAsOfDateTime",
    "validFromDateTime",
    "validTimeStateType",
    "validToDateTime",
    "mdsSalesInvoiceRecipient"
})
public class AxdMDSITGSInvRec {

    @XmlElementRef(name = "DocPurpose", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec", type = JAXBElement.class)
    protected JAXBElement<AxdEnumXMLDocPurpose> docPurpose;
    @XmlElementRef(name = "SenderId", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec", type = JAXBElement.class)
    protected JAXBElement<String> senderId;
    @XmlElementRef(name = "ValidAsOfDateTime", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec", type = JAXBElement.class)
    protected JAXBElement<AxdTypeDateTime> validAsOfDateTime;
    @XmlElementRef(name = "ValidFromDateTime", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec", type = JAXBElement.class)
    protected JAXBElement<AxdTypeDateTime> validFromDateTime;
    @XmlElementRef(name = "ValidTimeStateType", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec", type = JAXBElement.class)
    protected JAXBElement<AxdEnumAxdValidTimeStateType> validTimeStateType;
    @XmlElementRef(name = "ValidToDateTime", namespace = "http://schemas.microsoft.com/dynamics/2008/01/documents/MDS_ITGSInvRec", type = JAXBElement.class)
    protected JAXBElement<AxdTypeDateTime> validToDateTime;
    @XmlElement(name = "MDS_SalesInvoiceRecipient")
    protected List<AxdEntityMDSSalesInvoiceRecipient> mdsSalesInvoiceRecipient;
    ...
    /**
     * Gets the value of the mdsSalesInvoiceRecipient property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mdsSalesInvoiceRecipient property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMDSSalesInvoiceRecipient().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AxdEntityMDSSalesInvoiceRecipient }
     * 
     * 
     */
    public List<AxdEntityMDSSalesInvoiceRecipient> getMDSSalesInvoiceRecipient() {
        if (mdsSalesInvoiceRecipient == null) {
            mdsSalesInvoiceRecipient = new ArrayList<AxdEntityMDSSalesInvoiceRecipient>();
        }
        return this.mdsSalesInvoiceRecipient;
    }
