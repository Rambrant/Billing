...
public class FlowAzureAxTest extends AbstractMuleContextTestCase
{
    @Override
    protected ConfigurationBuilder getBuilder() throws Exception
    {
        return new SpringXmlConfigurationBuilder( new String[]
        {
            ...
            "spring/springServicesContext-barium-AzureAx.xml",
...
//            "flow/deliver-invoice-ax.xml",
    ...
    public static void beforeClass()
    {
        ...
        systemProperties.setProperty( "mule.test.timeoutSecs", "300000");
    }
